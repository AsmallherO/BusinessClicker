...
sealed class SystemMagazine : IEcsRunSystem, IEcsInitSystem
{
    private readonly EcsFilter<MagazineComponent,BalanceComponent> filter = null;
    public void Init()
    {
    ...
    public void AnimDoxod()
    {
        ...
        filter.Get1(1).ProgressBar.GetComponent<Image>().fillAmount += (0.1f * Time.deltaTime);

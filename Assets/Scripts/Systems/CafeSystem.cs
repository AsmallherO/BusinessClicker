...
sealed class CafeSystem : IEcsRunSystem, IEcsInitSystem
{
    private readonly EcsFilter<CafeComponent, BalanceComponent> filter = null;
    public void Init()
    {
    ...
    public void AnimDoxod()
    {
        ...
        filter.Get1(1).ProgressBar.GetComponent<Image>().fillAmount += (0.03f * Time.deltaTime);

...
sealed class BusSystem : IEcsRunSystem, IEcsInitSystem
{
    private readonly EcsFilter<BusComponent, BalanceComponent> filter = null;
    public void Init()
    {
    ...
    public void AnimDoxod()
    {
        ...
        filter.Get1(1).ProgressBar.GetComponent<Image>().fillAmount += (0.05f * Time.deltaTime);
